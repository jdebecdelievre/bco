# Copied from https://github.com/amirgholami/adahessian/blob/master/instruction/adahessian.py
...
class Adahessian(Optimizer):
    ...
    def get_trace(self, gradsH):
        ...
        params = [p for p in  self.param_groups[0]['params'] if p.requires_grad]
